...
sequenceDiagram
    ...
    %% NOTE: This Note (directive?) is reformatted to fit the page for this README,
    %% not sure of the status of line breaks in mermaid Notes.
    Note right of browser: The browser starts executing the 
                           JavaScript code that fetches the
